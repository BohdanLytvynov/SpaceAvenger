...
{
    [VisibleInEditor(FactoryName = nameof(EaseOutCubic),
        DisplayName = "Ease Out Cubic f(t)= 1-(1 - t)^3",
        GameObjectType = Enums.GEObjectType.Ease)]
    [BuildWithFactory<GEObjectType>(GameObjectType = GEObjectType.Ease)]
    public class EaseOutCubic : EaseBase, IEase
    {
        public override double Ease(double t) => base.Ease(t) * (1 - System.Math.Pow((1 - t), 3));
    }
}
