...
namespace WPFGameEngine.WPF.GE.Helpers
{
    public static class CollisionHelper
    {
        ...
        //    float closestX = SMath.Clamp(circle.CenterPosition.X, rect.LeftUpperCorner.X, rect.LeftUpperCorner.X + rect.Width);
        //    float closestY = SMath.Clamp(circle.CenterPosition.Y, rect.LeftUpperCorner.Y, rect.LeftUpperCorner.Y + rect.Height);

        //    // 2. Calculate distance between this nearest point and the Center of the Circle
        //    float dx = circle.CenterPosition.X - closestX;
        //    float dy = circle.CenterPosition.Y - closestY;
        //    float distanceSquared = dx * dx + dy * dy;
